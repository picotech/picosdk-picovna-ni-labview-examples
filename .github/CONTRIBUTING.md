...
```
git clone https://github.com/YOUR-USERNAME/picosdk-picovna-ni-labview-examples.git
```

2. Create a new branch - specify a name in lowercase, using hyphens to link words e.g. `new-vna-example`
